...
public class RegistryAccess {
  ...
  public static String readString(WinReg.HKEY topLevel, String key, String name) {
    return Advapi32Util.registryGetStringValue(topLevel, key, name);
  }

  public static void writeString(WinReg.HKEY topLevel, String key, String name, String value) {
    Advapi32Util.registrySetStringValue(topLevel, key, name, value);
  }

  public static int readInt(WinReg.HKEY topLevel, String key, String name) {
    return Advapi32Util.registryGetIntValue(topLevel, key, name);
  }
